...
|-----------|---------|-----------------|
| **Code shipped (Sep 22)** | 82/82 indexable (300w+), section pages, newsroom, RSS, consent defaults | **100%** scanner |
| **After §3 Sites review** | Request review in AdSense → Sites | **Matrix 99%+** |
...
| Original content | **Ready** | 82 articles, 82/82 indexable (300w+ / 2 min), ON008 pipeline, footer disclaimer |
...
| EU consent (CMP) | **Done** | Published in AdSense → Privacy & messaging (§2) |
| Site logo | **Done** | Uploaded in AdSense (≤148 KB) |
...
## §0. Disable Auto ads ✅ Done

Auto ads are **off** for `theassociatedguess.com` — manual header, in-content, and footer units only.

*(Reference: AdSense → **Ads** → **Auto ads** → **Off**.)*
...
EU consent message is **published** for `theassociatedguess.com`, linking to https://theassociatedguess.com/privacy.html.

Site logo uploaded in AdSense (Sep 22, 2026).

*(Reference: AdSense → **Privacy & messaging** → **European regulations**.)*
...
- [x] 82 articles, 82/82 indexable (300w+), sitemap + RSS + 8 section pages
...
- [x] §0 Disable Auto ads
- [x] §1 Slot IDs in config.js (push to live)
- [x] §2 Enable EU CMP in AdSense (links to privacy.html)
- [x] Site logo uploaded in AdSense
...
- [x] EU consent banner published (AdSense Privacy & messaging)
- [x] Auto ads **disabled**
